...
wall() {
  confirm="no"
  while [ "$confirm" = "no" ]; do 
    selected_wallpaper=$(ls /home/maverick/.wallpapers/ | dmenu -l 40 -p "Select image:")
    sxiv "/home/maverick/.wallpapers/$selected_wallpaper"
    confirm=$(echo "yes\nno" | dmenu -l 2)
    if [ "$confirm" = "yes" ]; then 
      feh --bg-center "/home/maverick/.wallpapers/$selected_wallpaper"
